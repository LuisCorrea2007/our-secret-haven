...
export function pickOfTheDay<T>(items: T[], offset = 0): T {
...
export const EVENT_CATEGORIES = [
  { value: "romantica", label: "Cita romántica" },
...
export const WISH_CATEGORIES = [
  { value: "lugar", label: "Lugar por visitar" },
  { value: "pelicula", label: "Película o serie" },
...
export const REACTIONS = [
  { type: "corazon", emoji: "❤️", label: "Corazón" },
  { type: "estrella", emoji: "⭐", label: "Estrella" },
  { type: "sonrisa", emoji: "😊", label: "Sonrisa" },
] as const;
